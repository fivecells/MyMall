    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-right">
        <div class="form-group">
          <input type="text" id="searchword" onkeyup="search()" class="form-control" placeholder="搜索商品">
        </div>
        <button type="submit" class="btn btn-default">搜索</button>
 		...
 		<div style="position:relative;width:675px;">
			<div id="showSearchProductDiv" style="border:1px solid #999;width:633px;display:none"></div>
		</div>
</body>
</html>